            ...
            SELECT
                ...
                <head>
                  ...
                  <style>
                    ...
                    * { box-sizing: border-box; }
                    ...
                    .header { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid #172033; padding-bottom: 12px; margin-bottom: 16px; }
                    ...
                    .field b { display: block; font-size: 9px; text-transform: uppercase; letter-spacing: .04em; color: #667085; }
                ...
                <body>
                  <div class="header">
                    ...
                    <div class="quote">
                      <span class="muted">Cotización</span>
                      <strong>{{rate.quoteNumber}}</strong>
                  ...
                  <table>
                    ...
                    <tbody>
                      {{#each items}}
                      <tr>
                        <td>{{description}}<div class="muted">{{notes}}</div></td>
                        <td class="num">{{quantity}}</td>
                        <td class="num">{{unitSale}}</td>
                  ...
                  <div class="terms">
                    <h3>Tarifa incluye</h3>
                    <div class="preline">{{rate.includes}}</div>
                  </div>
                  <div class="terms">
                    <h3>Sujeto a</h3>
                    <div class="preline">{{rate.subjectTo}}</div>
                  </div>
                  <div class="terms">
                    <h3>Tarifa no incluye</h3>
                    <div class="preline">{{rate.excludes}}</div>
                  </div>

                  <div class="footer">
                    Tiempo de tránsito estimado y sujeto a cambios sin previo aviso. Espacios sujetos a disponibilidad al momento de reservar. No incluye demoras ni servicios no indicados expresamente en esta cotización.
                  </div>
                </body>
                </html>
                $html$,
