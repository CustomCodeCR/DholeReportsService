...
[Migration("20260909190000_UpdatePricingClientQuoteCastroFallasHtml")]
public sealed class UpdatePricingClientQuoteCastroFallasHtml : Migration
{
    ...
    private const string SqlDelimiter = "$castro_fallas_quote$";

    protected override void Up(MigrationBuilder migrationBuilder)
    {
        var assembly = typeof(UpdatePricingClientQuoteCastroFallasHtml).Assembly;
