...
[Migration("20260909201500_RefreshPricingClientQuoteTemplate")]
public sealed class RefreshPricingClientQuoteTemplate : Migration
{
    ...
    private const string SqlDelimiter = "$castro_fallas_quote_refresh$";

    protected override void Up(MigrationBuilder migrationBuilder)
    {
        var assembly = typeof(RefreshPricingClientQuoteTemplate).Assembly;
